...
Public Sub MSCommConnect()
    ...
    addText vbCrLf & "Waiting for connection..."
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    addText vbCrLf & "Closing console." & vbCrLf

    freeFileNum = FreeFile
    Open CurDir & "\log.txt" For Append As freeFileNum
        Print #freeFileNum, txtConsole.Text;
    Close #freeFileNum
...
Private Sub addText(addString As String)
    ...
    If Len(txtConsole.Text) > 10000 Then
        freeFileNum = FreeFile
        Open CurDir & "\log.txt" For Append As freeFileNum
            Print #freeFileNum, Left(txtConsole.Text, 5000);
        Close #freeFileNum
        txtConsole.Text = Mid(txtConsole.Text, 5001)
    End If
